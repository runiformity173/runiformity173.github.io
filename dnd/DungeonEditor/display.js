...
function changeMode(newMode) {
    ...
    else if (mode == "room") changeRoom(Number(document.getElementById("roomSelector").value),false);
    else if (mode == "view") document.getElementById("roomDescriptionOutput").innerHTML = (roomDescriptions[room] || " ").replaceAll("\n","<br>");
    display();
    save();
}
function changeRoom(newRoom,redisplay=true) {
    if (mode == "room") {
        ...
        document.getElementById("roomDescriptionOutput").innerHTML = (roomDescriptions[newRoom] || " ").replaceAll("\n","<br>");
    }
    room = newRoom;
    if (mode == "layout") {
