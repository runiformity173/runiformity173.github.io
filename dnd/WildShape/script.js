function display() {
  if (window.location.hash) {
    document.getElementById("frame").contentWindow.location.replace("https://runiformity173.github.io/dnd/MonsterSearch/display/?monster="+window.location.hash.substring(1));
  }
}
display();
